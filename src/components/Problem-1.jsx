...
const Problem1 = () => {
    ...
    useEffect(() => {
        localforage.getItem('task').then(function (value) {
            setTask(value);
    ...
    const handleSubmit = (e) => {
        ...
        const taskInfo = { name, status };
        console.log(taskInfo);
        const taskDataValue = ([...task, taskInfo]);

        localforage.setItem('task', taskDataValue).then(function (value) {
            setTask(value);
            setFilteredItems(value);
        }).catch(function (err) {
            console.log(err);
